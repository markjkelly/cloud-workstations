...
| ID | Feature | Spec | Priority | Status | Owner | Branch | Dependencies | Feedback |
|----|---------|------|----------|--------|-------|--------|--------------|----------|
| F-0088 | Install Antigravity CLI via curl in 07-apps.sh | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-1 | main | F-0087 | Implemented idempotent install block in `workstation-image/boot/07-apps.sh`: installs on first boot if binary not found, re-runs installer on every subsequent boot for updates. Command: `curl -fsSL https://antigravity.google/cli/install.sh \| bash`. Logs to `$LOG_FILE`. |
| F-0089 | Update Dockerfile: replace legacy apt antigravity with 2.0 apt package | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-1 | main | F-0087 | Updated `workstation-image/Dockerfile` comment to note that auto-updater repo delivers Antigravity 2.0 automatically. Legacy apt package `antigravity` remains; auto-updater upgrades to 2.0 on boot. |
| F-0090 | Update sway config: keybinding for Antigravity 2.0 desktop app | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-2 | main | F-0087 | Updated `workstation-image/configs/sway/config`: comment changed to "Antigravity 2.0 desktop app", `$mod+n` keybinding correct and preserved. NOTE: `$mod+a` was accidentally changed to Antigravity in earlier edit, then restored to Clipman (correct binding). Tests verify correct keybindings. |
| F-0091 | Update 08-workspaces.sh: workspace 3 auto-launch Antigravity 2.0 | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-2 | main | F-0089, F-0090 | Updated `workstation-image/boot/08-workspaces.sh` comment for workspace 3 to reference Antigravity 2.0. Binary path `/usr/bin/antigravity` confirmed correct, timeout 30s retained. |
| F-0092 | Update 10-tests.sh: add boot tests for Antigravity CLI + 2.0 binary | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-2 | main | F-0088, F-0091 | Added two new tests to `workstation-image/boot/10-tests.sh`: verify Antigravity 2.0 binary at `/usr/bin/antigravity`, verify Antigravity CLI at `~/.local/bin/antigravity-cli` or on PATH. |
| F-0093 | Update cloud-build-setup.sh: Antigravity CLI + 2.0 in fresh provisioning | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-3 | main | F-0088, F-0089 | Updated `scripts/cloud-build-setup.sh`: added Antigravity CLI curl install during fresh provisioning. Updated verification step to check for both `antigravity` (2.0) and `antigravity-cli`. |
| F-0094 | Add Antigravity CLI PATH to 05-shell.sh if needed | [F-0040](specs/F-0040-antigravity-2-cli.md) | P1 | done | SWE-3 | main | F-0088 | Verified `~/.local/bin` already in PATH in `workstation-image/boot/05-shell.sh` (no shell change needed). Added clarifying comment to the PATH setup to document that CLI will be found automatically. |
